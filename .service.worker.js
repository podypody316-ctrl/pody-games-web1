...
/** @type {string} */
const CACHE_VERSION = '1776370461|80180026';
/** @type {string} */
const CACHE_PREFIX = 'pody games web-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = [".html",".js",".offline.html",".icon.png",".apple-touch-icon.png",".audio.worklet.js",".audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = [".wasm",".pck"];
